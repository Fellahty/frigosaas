...
const loginSchema = z.object({
  loginField: z.string().min(1, 'Email or phone is required'),
      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-white/80 backdrop-blur-sm rounded-3xl shadow-xl border border-white/20 p-8">
          <form className="space-y-6" onSubmit={handleSubmit(onSubmit)}>
            ...
            {/* Login Field */}
            <div>
              <label htmlFor="loginField" className="block text-sm font-semibold text-gray-700 mb-2">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  placeholder={loginType === 'email' ? 'votre@email.com' : '0666507474'}
                />
              </div>
              {errors.loginField && (
        ...
        <div className="text-center mt-8">
          <p className="text-sm text-gray-500">
            © 2024 Frigo SaaS. Tous droits réservés.
          </p>
        </div>
      </div>
    </div>
